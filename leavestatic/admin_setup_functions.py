...
def edit_staff(form_data):
    try:
        ...
        staff.seniority = Seniority.objects.get(id=int(form_data['seniority']))
        ...
        # You could log the error or handle it depending on your needs
...
def del_staff(form_data):
    ...
    if isinstance(staff_ids, str):
        ...
        # If coming from Django QueryDict, it may be a list of strings
