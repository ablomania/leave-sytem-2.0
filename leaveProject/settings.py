...
# 'django-insecure-+z%@)*!vygr9b-ivihdu2_94r4rtfgc6-8o&-0vqsx34old3+@%4xwp5e*'
...
#         'NAME': 'leave_system_db',
#         # 'NAME': config('DB_NAME', default='leave_system_db'),
#         'USER': 'postgres',
#         'PASSWORD': '1234',
#         'HOST': 'localhost',
#         'PORT': '5432'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'leave_system_db'),
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='gcpsleavesystem@gmail.com')
...
SESSION_COOKIE_AGE = 86400  # Expire session after 1 day
